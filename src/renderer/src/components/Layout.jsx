      ...
      <aside className="flex w-64 shrink-0 flex-col bg-navy text-paper">
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 rounded-xl bg-white/[0.06] p-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-orange-soft font-heading text-sm font-bold text-orange">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-hairline bg-paper/80 px-8 py-4 backdrop-blur">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-orange-soft font-heading text-sm font-bold text-orange">
              {initials(user.full_name)}
            </div>
          </div>
        </header>
